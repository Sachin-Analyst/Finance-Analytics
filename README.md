...
## Introduction
--- 
*Project Title:* Finance Analytics  
*Created By:* [Sachin-Analyst](https://github.com/Sachin-Analyst)  
*Tools Used:*  Excel  
*Focus Areas:* Financial Growth & Stability,Customer Experience and Operational Excellence
...
- P&L Reports by Fiscal Year
- Granular Monthly and Quarterly Analysis
- Market-Specific Profitability Insights
...
1. *Clone the repository:*   
   ...
   git clone https://github.com/Sachin-Analyst/Finance-Anaytics
...
Due to the large file size and complex data modeling of the Excel workbook To maintain repository performance, the source Excel Solution File is not included in the main branch but Screen Recorded is added and the project methodology and results are instead fully documented through high-fidelity PDF reports, showcasing the Advanced Excel Pivot Tables and Fiscal Tracking Systems developed during the analysis
